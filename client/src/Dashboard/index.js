          ...
          <Col lg={3}>
            <Card>
              <CardBody>
                ...
                <h4 className="mt-4">{newOrders}</h4>
                <div className="row">
                  <div className="col-7">
                    <p className="mb-0"><span className="text-success me-2"> {newOrders} <i
            ...
            >
              <CardBody>
                ...
                <h4 className="mt-4">{newUsers}</h4>
                <Row>
                  <div className="col-7">
                    <p className="mb-0"><span className="text-success me-2"> {newUsers}<i
                      className="mdi mdi-arrow-up"></i> </span></p>
                  </div>
                  <div className="col-5 align-self-center">
                    <Progress
